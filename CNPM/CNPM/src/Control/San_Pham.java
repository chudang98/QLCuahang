...
public class San_Pham {
    ...
    private String ten_cua_hang; //id cua_hang

    public San_Pham(String ma_san_pham, String ten_san_pham, String loai_san_pham, int gia_nhap, int gia_ban, String mau_sac, String kich_co, String ten_cua_hang) {
